...
/// </summary>
public sealed record DynamicAttributeDefinition(Guid Id, string DisplayName, string SystemName, AttributeDataType DataType, Type? TargetEntity = null, KeyType KeyType = KeyType.Int,
