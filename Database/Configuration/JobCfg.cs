...
public class JobCfg : IEntityTypeConfiguration<Job>
{
    public void Configure(EntityTypeBuilder<Job> builder)
    {
        ...
        builder.Property(job => job.Name).HasColumnName("Name").IsRequired();
        builder.Property(job => job.InstanceId).HasColumnName("InstanceId").IsRequired();
        ...
        builder.HasIndex(job => new { job.Status, job.Type, ConnectorInstanceId = job.InstanceId });
    }
}